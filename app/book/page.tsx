...
// const services = ["Laser Hair Removal", "Skin Rejuvenation", "Tattoo Removal", "Acne Treatment", "Consultation Only"]
...
//                   className="bg-white rounded-3xl p-8 luxury-shadow"
//                 >
//                   <h2 className="text-3xl font-playfair font-bold text-gray-900 mb-8">Schedule Your Visit</h2>
...
//                       className="w-full bg-amber-600 rounded-xl hover:bg-amber-700 text-white py-4 text-lg"
//                     >
...
//                     <h3 className="text-2xl font-playfair font-bold text-gray-900 mb-6">Contact Information</h3>
//                     <div className="space-y-4">
...
//                         <span className="text-gray-700">info@drabclinic.com</span>
//                       </div>
//                       <div className="flex items-start">
//                         <Calendar className="w-5 h-5 text-amber-600 mr-3 mt-1" />
//                         <div>
//                           <div className="text-gray-700 font-medium">Business Hours</div>
...
//                   {/* What to Expect */}
//                   <div className="bg-white rounded-3xl p-8 luxury-shadow">
//                     <h3 className="text-2xl font-playfair font-bold text-gray-900 mb-6">What to Expect</h3>
//                     <div className="space-y-4">
//                       <div className="flex items-start">
...
//                           <div className="text-gray-600 text-sm">We'll discuss your goals and assess your needs</div>
//                         </div>
//                       </div>
//                       <div className="flex items-start">
//                         <div className="w-8 h-8 bg-amber-100 rounded-full flex items-center justify-center mr-3 mt-1">
...
//                         </div>
//                         <div>
//                           <div className="font-medium text-gray-900">Treatment Plan</div>
//                           <div className="text-gray-600 text-sm">
...
//                           <div className="text-gray-600 text-sm">Ongoing support and progress monitoring</div>
//                         </div>
//                       </div>
//                     </div>
//                   </div>
