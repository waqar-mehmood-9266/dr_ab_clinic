...
// Book Now Mobile view errors fixed
...
const services = [
  ...
  "Baby Doll Facial / Carbon Facial",
  "Vampire Facial",
  "Derma Abrasion",
  "BB Glow Facial",
  "LED Light Facial",
  ...
  "Whitening Drops",
  "Whitening Medicine",
  "Whitening Peel / Facial",

  // Drips
  "Multivitamin Drips",
  "Nutrition Drips",
  "Collagen Drips (Wrinkle Free / Korean Skin)",
  "Glowing Drips",
...
export default function BookPage() {
  ...
  const renderStepIndicator = () => (
    <div className="step-indicator flex items-center justify-center mb-8 px-4">
      <div className="flex items-center">
        {[1, 2, 3, 4].map((step) => (
          <div key={step} className="flex items-center">
            ...
            {step < 4 && (
              <div className={`w-8 md:w-16 h-1 mx-1 md:mx-2 ${step < currentStep ? "bg-amber-600" : "bg-gray-200"}`} />
            )}
          </div>
        ))}
      </div>
  ...
  const renderStep1 = () => (
    ...
    >
      <div className="text-center mb-6">
        <h3 className="text-xl md:text-2xl font-playfair font-bold text-gray-900 mb-2">Appointment Details</h3>
        <p className="text-gray-600 text-sm md:text-base">
          Let's start with your basic information and preferred appointment time.
        </p>
      </div>
  ...
  const renderStep2 = () => (
    ...
    >
      <div className="text-center mb-6">
        <h3 className="text-xl md:text-2xl font-playfair font-bold text-gray-900 mb-2">Personal Information</h3>
        <p className="text-gray-600 text-sm md:text-base">
          Please provide additional personal details for your treatment file.
        </p>
      </div>
  ...
  const renderStep3 = () => (
    ...
    >
      <div className="text-center mb-6">
        <h3 className="text-xl md:text-2xl font-playfair font-bold text-gray-900 mb-2">Medical History</h3>
        <p className="text-gray-600 text-sm md:text-base">
          This information helps us provide the safest and most effective treatment.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base md:text-lg">Previous Treatments</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            <Label className="text-gray-700 mb-3 block text-sm md:text-base">
              Have you had IPL/Laser Therapy or any other treatment previously?
            </Label>
            <RadioGroup
              value={formData.previousTreatment}
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base md:text-lg">Health Conditions</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <Label className="text-gray-700 mb-3 block text-sm md:text-base">Bleeding disorder</Label>
              <RadioGroup
                value={formData.bleedingDisorder}
                onValueChange={(value) => handleInputChange("bleedingDisorder", value)}
              >
            ...
            <div>
              <Label className="text-gray-700 mb-3 block text-sm md:text-base">Are you pregnant?</Label>
              <RadioGroup value={formData.pregnant} onValueChange={(value) => handleInputChange("pregnant", value)}>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="yes" id="pregnant-yes" />
                  <Label htmlFor="pregnant-yes">Yes</Label>
            ...
            <div>
              <Label className="text-gray-700 mb-3 block text-sm md:text-base">Allergies</Label>
              <RadioGroup value={formData.allergies} onValueChange={(value) => handleInputChange("allergies", value)}>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="yes" id="allergies-yes" />
                  <Label htmlFor="allergies-yes">Yes</Label>
            ...
            <div>
              <Label className="text-gray-700 mb-3 block text-sm md:text-base">Are you Diabetic?</Label>
              <RadioGroup value={formData.diabetic} onValueChange={(value) => handleInputChange("diabetic", value)}>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="yes" id="diabetic-yes" />
                  <Label htmlFor="diabetic-yes">Yes</Label>
          ...
          <div>
            <Label className="text-gray-700 mb-3 block text-sm md:text-base">Are you taking any supplements?</Label>
            <RadioGroup
              value={formData.takingSupplements}
              onValueChange={(value) => handleInputChange("takingSupplements", value)}
            >
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <Label className="text-gray-700 mb-3 block text-sm md:text-base">Do you use sunblock?</Label>
              <RadioGroup
                value={formData.useSunblock}
                onValueChange={(value) => handleInputChange("useSunblock", value)}
              >
            ...
            <div>
              <Label className="text-gray-700 mb-3 block text-sm md:text-base">Do you use tanning lotion?</Label>
              <RadioGroup
                value={formData.useTanningLotion}
                onValueChange={(value) => handleInputChange("useTanningLotion", value)}
              >
          ...
          <div>
            <Label className="text-gray-700 mb-3 block text-sm md:text-base">
              Have you treated in this area before?
            </Label>
            <RadioGroup
              value={formData.treatedAreaBefore}
              onValueChange={(value) => handleInputChange("treatedAreaBefore", value)}
  ...
  const renderStep4 = () => (
    ...
    >
      <div className="text-center mb-6">
        <h3 className="text-xl md:text-2xl font-playfair font-bold text-gray-900 mb-2">Treatment Consent</h3>
        <p className="text-gray-600 text-sm md:text-base">
          Please read and acknowledge the following information carefully.
        </p>
      </div>

      <Card className="border-amber-200">
        <CardHeader className="bg-amber-50">
          <CardTitle className="flex items-center text-amber-800 text-base md:text-lg">
            <AlertTriangle className="w-5 h-5 mr-2" />
            Important Treatment Information
          </CardTitle>
        </CardHeader>
        <CardContent className="p-4 md:p-6">
          <div className="prose prose-sm max-w-none text-gray-700 space-y-4 text-sm md:text-base">
            <p>
              It has been explained to me that IPL/Laser Aesthetic treatment will help to improve the condition and the
              appearance of the area being treated and that clinical results may vary from person to person. I
              understand that multiple treatments are necessary to achieve optimal results.
      ...
      <div className="space-y-4">
        <div className="flex items-start space-x-3">
          <Checkbox
            ...
            onCheckedChange={(checked) => handleInputChange("understandTreatment", checked as boolean)}
          />
          <Label htmlFor="understandTreatment" className="text-xs md:text-sm text-gray-700 leading-relaxed">
            I understand that multiple treatments are necessary to achieve optimal results and that clinical results may
            vary from person to person.
          </Label>
        </div>
        ...
        <div className="flex items-start space-x-3">
          <Checkbox
            ...
            onCheckedChange={(checked) => handleInputChange("understandRisks", checked as boolean)}
          />
          <Label htmlFor="understandRisks" className="text-xs md:text-sm text-gray-700 leading-relaxed">
            I understand all possible risks and side effects have been explained to me, including reddening, mild
            burning, temporary bruising, discoloration, blistering, and mild scarring.
          </Label>
        </div>
        ...
        <div className="flex items-start space-x-3">
          <Checkbox
            ...
            onCheckedChange={(checked) => handleInputChange("informationAccurate", checked as boolean)}
          />
          <Label htmlFor="informationAccurate" className="text-xs md:text-sm text-gray-700 leading-relaxed">
            I confirm all information provided by me is accurate and complete.
          </Label>
        </div>
        ...
        <div className="flex items-start space-x-3">
          <Checkbox
            ...
            onCheckedChange={(checked) => handleInputChange("consentToTreatment", checked as boolean)}
          />
          <Label htmlFor="consentToTreatment" className="text-xs md:text-sm text-gray-700 leading-relaxed">
            I agree that I fully understand all information given to me verbally and within this disclaimer. I consent
            to having my treatment at DR.AR AESTHETIC CLINIC.
          </Label>
        </div>
    ...
    <div className="min-h-screen luxury-gradient">
      ...
      <main className="pt-24">
        ...
        <section className="py-8 md:py-16">
          <div className="container mx-auto px-4 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mx-auto">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-playfair font-bold text-gray-900 mb-6">
                Book Your
                <span className="block gold-accent">Appointment</span>
              </h1>
        ...
        <section className="py-8 md:py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-3xl p-4 md:p-8 luxury-shadow">
                {renderStepIndicator()}
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {/* Navigation Buttons */}
                  <div className="flex flex-col md:flex-row justify-between mt-8 pt-6 border-t border-gray-200 space-y-3 md:space-y-0">
                    <Button
                      type="button"
                      onClick={prevStep}
                      disabled={currentStep === 1}
                      variant="outline"
                      className="flex items-center bg-transparent order-2 md:order-1"
                    >
                      <ChevronLeft className="w-4 h-4 mr-2" />
                      Previous
                    </Button>
                    ...
                    {currentStep < 4 ? (
                      <Button
                        ...
                        onClick={nextStep}
                        disabled={!canProceedToNextStep()}
                        className="bg-amber-600 hover:bg-amber-700 flex items-center order-1 md:order-2"
                      >
                        Next
                        <ChevronRight className="w-4 h-4 ml-2" />
                      </Button>
